  ...
  return new Level(
    ...
    [
      ...
      new BackgroundObject(
        "img/4.Background/Layers/5. Water/D1.png",
        880 * 2,
        0
      ),
      new BackgroundObject(
        "img/4.Background/Layers/4.Fondo 2/D1.png",
        880 * 2,
        0
      ),
      new BackgroundObject(
        "img/4.Background/Layers/3.Fondo 1/D1.png",
        880 * 2,
        0
      ),
      new BackgroundObject(
        "img/4.Background/Layers/2. Floor/D1.png",
        880 * 2,
        0
      ),
      new BackgroundObject(
        "img/4.Background/Layers/1. Light/1.png",
        880 * 2,
        0
      ),

      new BackgroundObject(
        "img/4.Background/Layers/5. Water/D2.png",
        880 * 3,
        0
      ),
      new BackgroundObject(
        "img/4.Background/Layers/4.Fondo 2/D2.png",
        880 * 3,
        0
      ),
      new BackgroundObject(
        "img/4.Background/Layers/3.Fondo 1/D2.png",
        880 * 3,
        0
      ),
      new BackgroundObject(
        "img/4.Background/Layers/2. Floor/D2.png",
        880 * 3,
        0
      ),
      new BackgroundObject(
        "img/4.Background/Layers/1. Light/2.png",
        880 * 3,
        0
      ),
